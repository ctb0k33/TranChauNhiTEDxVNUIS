...
class SponsorshipLevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sponsorship_level" do
    assert_difference("SponsorshipLevel.count") do
      post sponsorship_levels_url, params: { sponsorship_level: { Description: @sponsorship_level.Description, Level_ID: @sponsorship_level.Level_ID, Sponsorship_Level: @sponsorship_level.Sponsorship_Level, Value: @sponsorship_level.Value } }
    end
  ...
  test "should update sponsorship_level" do
    patch sponsorship_level_url(@sponsorship_level), params: { sponsorship_level: { Description: @sponsorship_level.Description, Level_ID: @sponsorship_level.Level_ID, Sponsorship_Level: @sponsorship_level.Sponsorship_Level, Value: @sponsorship_level.Value } }
